...
const introPopup = L.popup({
  ...
  .setContent(`
    <div style="text-align:center;">
      ...
      <p>Discover which languages are spoken in every corner of the world! Click on diamonds to explore languages spoken and note that some languages that have wide use will only show the main country (ex. English being in England and Spanish being in Spain). So far we have 16 languages.</p>
